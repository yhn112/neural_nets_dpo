...
\setmainfont{Liberation Sans}  % задаёт основной шрифт документа
...
\begin{wideitemize}
	...
	\item все материалы можно найти на  \href{https://github.com/dniku/neural_nets_dpo}{страничке курса}
