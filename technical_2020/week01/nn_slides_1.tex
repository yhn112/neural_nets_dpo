...
\begin{wideitemize}
	...
	%\item Правила игры + что читать/смотреть, каким будет курс
...
\begin{wideitemize}
	...
	\item  на парах смотрим презы, пишем код, решаем задачи, много говорим
	
	\item  будет математика 
...
%	\item  на парах смотрим презы, пишем код, решаем задачи, много говорим
%	
%	\item  будет много математики 
%	
%	\item  на кодинговые пары лучше приходить со своим ноутбуком
%	
%	\item все материалы можно найти на  \href{https://fulyankin.github.io/neural_nets_econ}{страничке курса}
%\end{wideitemize} 
%\end{frame}
...
\node[right=0.5cm of B.east, align=left, shift={(0cm,-1.5cm)}, text width=6cm, font=\scriptsize, fill=yellow] (C2) {
	...
	\item  Введение в NLP, эмбединги, автопереводы
...
\begin{transitionframe}
	\begin{center}
		\Huge Учим свою первую нейросеть в Keras!
	\end{center}
\end{transitionframe}
