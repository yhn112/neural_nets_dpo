...
\begin{frame}{Свёртка в виде формулы}
\begin{center}
	\includegraphics[width=.8\linewidth]{cconv_4.png}
\end{center}
\end{frame}
...
\begin{frame}{Replication padding}
\begin{center}
	\includegraphics[width=.8\linewidth]{replication_pad.png}
\end{center}
...
\begin{frame}{Padding}
\begin{wideitemize}
	\item Паддинг позволяет контролировать размер выходных изображений
	\item Паддинг позволяет учитывать даже объекты на краях
...
\begin{frame}{Data augmentation}
\begin{center}
	\includegraphics[width=.45\linewidth]{parrot.jpeg}
\end{center}
\vfill
\footnotesize
{\color{blue} \url{https://github.com/albumentations-team/albumentations}}
\end{frame}
...
\begin{wideitemize}
	...
	\item Такие векторные представления называют \alert{эмбедингами}
	\item У эмбедингов нет чёткой интерпретации, цифры в них говорят о наличии каких-то паттернов, на которые настроилась нейросетка
	\item Эмбединги картинок оказываются полезными во многих задачах 
\end{wideitemize}
\end{frame}
